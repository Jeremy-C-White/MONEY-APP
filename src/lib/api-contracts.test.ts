...
describe('Walmart response contracts', () => {
  const insights = {
    ...
    trend: [{ periodStart: '2026-08-01', totalSpend: 120, retailSpend: 80, fuelSpend: 40, orderCount: 2 }],
    monthly: [{ month: '2026-08', totalSpend: 120, fuelSpend: 40, orderCount: 2 }],
    fuelGrades: [{ grade: 'Regular', spend: 40, gallons: 10, fillUpCount: 1, averagePricePerGallon: 4 }],
    fuelPurchases: [{
      orderNumber: 'fuel-1',
      date: '2026-08-28',
